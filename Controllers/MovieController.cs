...
namespace MovieApp.Controllers
{
    public class MovieController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ReleaseYear,Title,OriginEthinicity,Director,Cast,Genre,WikiPage,Plot")] MovieModel movieModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ReleaseYear,Title,OriginEthinicity,Director,Cast,Genre,WikiPage,Plot")] MovieModel movieModel)
        {
            if (id != movieModel.Id)
            {
                return NotFound();
